...
namespace NdJson.SourceGeneration
{
    ...
    {
        internal static string Convert(string name, NamingPolicy policy)
        {
            ...
            switch (policy)
            {
                ...
                case NamingPolicy.PascalCase:
                    return ToPascalCase(name);
                case NamingPolicy.SnakeCaseLower:
                    return ToSeparated(name, '_', false);
                case NamingPolicy.SnakeCaseUpper:
                    return ToSeparated(name, '_', true);
                case NamingPolicy.KebabCaseLower:
                    return ToSeparated(name, '-', false);
                case NamingPolicy.KebabCaseUpper:
